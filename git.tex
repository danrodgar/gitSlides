...
\author{Daniel Rodriguez, David F. Barrero}
...
\begin{itemize}
 \item \alert{GitHub} allow us unlimited public repositories, but private ones are not free (except for academia). It is now part of Microsoft.
 \item \alert{Bitbucket} allow us to keep private repositories limiting the number of collaborators.
 \item \alert{GitLab} allows both public and private repositories without limitations. It is becoming more popular.
\end{itemize}
...
\texttt{git add <file>} makes git track the file \texttt{<file>}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Using Git}%{Basic commands: Graphically}

\centering
\includegraphics[width=.7\textwidth,height=\textheight,keepaspectratio]{figs/gitWorkflow.jpeg}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}{Using Git}{Advanced Git: Pull Requests}
...
\begin{frame}{GitHub}{GitHub Pages}
	...
	\begin{itemize}
		...
		\item Documentation
		\item Based on Markdown (and \textit{Jekyll})
	\end{itemize}
